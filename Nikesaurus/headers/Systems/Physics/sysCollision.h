...
namespace NIKE {
    namespace Collision {
        ...
        private:
            ...
            std::vector<Vector2f> getRotatedVertices(const Transform::Transform& transform, const Physics::Collider& collider, const std::string& model_id);
        ...
        public:
            ...
            bool detectSATCollision(const Transform::Transform& transformA, const Transform::Transform& transformB, const Physics::Collider& colliderA, const Physics::Collider& colliderB, const std::string& model_idA, const std::string& model_idB, CollisionInfo& info);
