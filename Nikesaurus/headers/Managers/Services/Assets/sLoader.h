...
namespace NIKE {
	namespace Assets {
		...
		struct Vertex {
			...
			Vector4f col;
			Vector2f tex_coords;
			int sampler_idx;	// index to use in sampler2DArray
			...
			Vertex(const Vector2f& pos, const Vector4f& col, const Vector2f& tex_coords, int sampler_idx, const Matrix_33& transform) : pos{ pos }, col{ col }, tex_coords{ tex_coords }, transform(transform), sampler_idx{ sampler_idx } {}
			Vertex(const Vector2f& pos, const Vector4f& col, const Vector2f& tex_coords, int sampler_idx, const Matrix_33& transform, const Vector2f& framesize, const Vector2f& uv_offset) : pos{ pos }, col{ col }, tex_coords{ tex_coords }, transform{ transform }, sampler_idx{ sampler_idx }, framesize{ framesize }, uv_offset{ uv_offset } {}
		};
