...
namespace NIKESAURUS {
	...
	*********************************************************************/
	...
	void Assets::Manager::registerSoundAudio(std::string const& file_path, std::string const& audio_tag)
	{
		...
		audio_list[audio_tag] = NIKEEngine.getService<Coordinator::Manager>()->accessSystem<Audio::Manager>()->NEAudioLoadSound(file_path);
	}
	...
	void Assets::Manager::registerMusicAudio(std::string const& file_path, std::string const& audio_tag)
	{
		...
		audio_list[audio_tag] = NIKEEngine.getService<Coordinator::Manager>()->accessSystem<Audio::Manager>()->NEAudioLoadMusic(file_path);
	}
	...
	void Assets::Manager::createAudioGroup(std::string const& audio_group_tag)
	{
		...
		audio_group_list[audio_group_tag] = NIKEEngine.getService<Coordinator::Manager>()->accessSystem<Audio::Manager>()->CreateAudioGroup(audio_group_tag);
	}
