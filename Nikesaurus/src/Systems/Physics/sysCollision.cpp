...
namespace NIKESAURUS {
    ...
    */
    ...
    bool Collision::Manager::detectMClickRect([[maybe_unused]] const Vector2& center, [[maybe_unused]] float width, [[maybe_unused]] float height) {
    ...
    bool Collision::Manager::detectMClickCircle([[maybe_unused]]const Vector2& center, [[maybe_unused]] float radius) {
